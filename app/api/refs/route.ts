...
export async function POST(req: NextRequest) {
  ...
  const prompt = `Фотореалистичные референсы интерьеров (${roomList}) в стиле из ТЗ. Чистые ракурсы, естественный свет, продвинутая композиция, высокий уровень отделки. Детали и палитра строго по ТЗ ниже.\n\nТЗ:\n` + brief;
